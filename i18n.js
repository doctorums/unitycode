...
(function(){
  ...
  var DICT = {
    ...
    , es:`<span class="wl">Escribes lo que te inquieta,</span><br><span class="wl">y la IA te ayuda a ver en ello</span><br><em class="wl">conexiones ocultas y sentidos nuevos.</em><br><span class="wl">Aquí no se dan respuestas.</span><br><span class="wl">Aquí se te ayuda.</span>`, fr:`<span class="wl">Vous écrivez ce qui vous préoccupe,</span><br><span class="wl">et l'IA vous aide à y voir</span><br><em class="wl">des liens cachés et des sens nouveaux.</em><br><span class="wl">Ici, on ne donne pas de réponses.</span><br><span class="wl">Ici, on vous aide.</span>`},
    ...
    'set.yourNode': { ru:`// ТВОЙ УЗЕЛ`,   en:`// YOUR NODE` , es:`// TU NODO`, fr:`// VOTRE NŒUD`},
    ...
    'set.btnYourNode':{ru:`[ это твой узел ]`,  en:`[ this is your node ]` , es:`[ este es tu nodo ]`, fr:`[ c'est votre nœud ]`},
    'set.btnChooseNoise':{ru:`[ выбери свой шум ↓ ]`, en:`[ choose your noise ↓ ]` , es:`[ elige tu ruido ↓ ]`, fr:`[ choisissez votre bruit ↓ ]`},
    ...
    'set.stError':  { ru:`✗ ошибка, ещё раз`, en:`✗ error, try again` , es:`✗ error, inténtalo de nuevo`, fr:`✗ erreur, réessayez`},
    ...
    'set.keyDesc': { ru:`Введи своё кодовое слово чтобы узнать свои узлы. Или пропусти — карта откроется без идентификации.`, en:`Enter your code word to recognize your own nodes. Or skip — the map opens without identification.` , es:`Introduce tu palabra clave para reconocer tus propios nodos. O sáltalo — el mapa se abre sin identificación.`, fr:`Entrez votre mot clé pour reconnaître vos propres nœuds. Ou passez — la carte s'ouvre sans identification.`},
    'set.keyPhrase': { ru:`твоя фраза...`, en:`your phrase...` , es:`tu frase...`, fr:`votre phrase...`},
    ...
    'implant.tagYourNode': { ru:`// ТВОЙ УЗЕЛ`, en:`// YOUR NODE` , es:`// TU NODO`, fr:`// VOTRE NŒUD`},
    ...
    'implant.statYourNoises': { ru:`Твоих шумов`, en:`Your noise` , es:`Tu ruido`, fr:`Votre bruit`},
    ...
    'implant.uzorTapHint': { ru:`тапни, чтобы увеличить`, en:`tap to enlarge` , es:`toca para ampliar`, fr:`touchez pour agrandir`},
    ...
    'implant.charHint': { ru:`Выбор тона анализа`, en:`Choose analysis tone` , es:`Elige el tono del análisis`, fr:`Choisissez le ton de l'analyse`},
    ...
    'implant.labelYourPattern': { ru:`// ПАТТЕРН ТВОЕГО УЗЛА`, en:`// PATTERN OF YOUR NODE` , es:`// PATRÓN DE TU NODO`, fr:`// MOTIF DE VOTRE NŒUD`},
    ...
    'materials.forkHow': { ru:`Как форкнуть`, en:`How to fork` , es:`Cómo hacer un fork`, fr:`Comment faire un fork`},
    ...
    'petlya.netDidntHear':{ ru:`Сеть не расслышала, попробуй ещё раз`, en:`The Network didn't catch it, try again` , es:`La Red no lo captó, inténtalo de nuevo`, fr:`Le Réseau n'a pas capté, réessayez`},
    'petlya.signalUnrecognized':{ ru:`Сигнал не распознан`, en:`Signal not recognized` , es:`Señal no reconocida`, fr:`Signal non reconnu`},
    'petlya.notYourNoise':{ ru:`Это не ваш шум)`, en:`This isn't your noise)` , es:`Este no es tu ruido)`, fr:`Ce n'est pas votre bruit)`},
    ...
    'petlya.phrasePlaceholder':{ ru:`твоя фраза...`, en:`your phrase...` , es:`tu frase...`, fr:`votre phrase...`},
    ...
    // — Книга (kniga.html) —
    'kniga.title':    { ru:`Бог, бесконечность и ты · UnityCode`, en:`God, Infinity and You · UnityCode` , es:`Dios, el Infinito y tú · UnityCode`, fr:`Dieu, l'Infini et vous · UnityCode`},
    'kniga.bkTitle':  { ru:`Бог, бесконечность и ты`, en:`God, Infinity and You` , es:`Dios, el Infinito y tú`, fr:`Dieu, l'Infini et vous`},
    ...
    'kniga.bmEmpty':  { ru:`Пока нет закладок. Наведи на абзац и нажми ⚑.`, en:`No bookmarks yet. Hover over a paragraph and tap ⚑.` , es:`Aún no hay marcadores. Pasa sobre un párrafo y toca ⚑.`, fr:`Pas encore de signets. Survolez un paragraphe et touchez ⚑.`},
    ...
    , fr:`c'est probablement déjà arrivé — seule la confirmation s'est perdue. Pas besoin d'attendre : vous pouvez continuer à écrire ou vérifier dans le Réseau`},

    'implant.deltaTag':    { ru:`// ПОКА ТЕБЯ НЕ БЫЛО`, en:`// WHILE YOU WERE AWAY`, es:`// MIENTRAS NO ESTABAS` , fr:`// PENDANT VOTRE ABSENCE`},
    'implant.deltaPrefix': { ru:`С прошлого визита: `, en:`Since your last visit: `, es:`Desde tu última visita: ` , fr:`Depuis votre dernière visite : `},
    'implant.deltaNodes': {
    ...
    , fr:`<span class="delta-accent">{n}</span> nouveau lien a touché vos nœuds||<span class="delta-accent">{n}</span> nouveaux liens ont touché vos nœuds`},
    'implant.deltaTap': {
    ...
    , fr:` <span class="delta-accent">&middot; touchez &mdash; une lecture du nouveau</span>`},
    ...
    'implant.legendThread': { ru:`твоя нить`,    en:`your thread`,        es:`tu hilo` , fr:`votre fil`},
