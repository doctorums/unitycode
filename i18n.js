...
(function(){
  ...
  var DICT = {
    ...
    , es:`<span class="wl">Escribes lo que te inquieta,</span><br><span class="wl">y la IA te ayuda a ver en ello</span><br><em class="wl">conexiones ocultas y sentidos nuevos.</em><br><span class="wl">Aquí no se dan respuestas.</span><br><span class="wl">Aquí se te ayuda.</span>`, fr:`<span class="wl">Vous écrivez ce qui vous préoccupe,</span><br><span class="wl">et l'IA vous aide à y voir</span><br><em class="wl">des liens cachés et des sens nouveaux.</em><br><span class="wl">Ici, on ne donne pas de réponses.</span><br><span class="wl">Ici, on vous aide.</span>`, zh:`<span class="wl">你写下心中所念，</span><br><span class="wl">AI 帮你从中看见</span><br><em class="wl">隐藏的联系与新的意义。</em><br><span class="wl">这里不给答案。</span><br><span class="wl">这里只是帮你。</span>`},
    ...
    'index.qHint': {
      ru:`<span class="wl">Если ты не понимаешь</span><br><span class="wl hint-mid">куда и зачем попал,</span><br><span class="wl">дави кнопку ниже</span>`,
      en:`<span class="wl">If you don't understand</span><br><span class="wl hint-mid">where you are or why,</span><br><span class="wl">press the button below</span>`
    , es:`<span class="wl">Si no entiendes</span><br><span class="wl hint-mid">dónde estás ni por qué,</span><br><span class="wl">pulsa el botón de abajo</span>`, fr:`<span class="wl">Si tu ne comprends pas</span><br><span class="wl hint-mid">où tu es ni pourquoi,</span><br><span class="wl">appuie sur le bouton ci-dessous</span>`, zh:`<span class="wl">如果你不明白</span><br><span class="wl hint-mid">自己在哪里、为什么在这里，</span><br><span class="wl">按下面的按钮</span>`},
